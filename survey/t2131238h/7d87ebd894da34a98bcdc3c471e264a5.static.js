...
window.addEventListener('DOMContentLoaded', () => {
    ...
    function applyTimeout() {
        setTimeout( () => applyTimeoutTemplate(0, 'คุณตอบคำถามทั้ง 4 ข้อแล้ว.'), 2000);
        setTimeout( () => applyTimeoutTemplate(1, 'ที่อยู่ IP ของคุณถูกต้องสำหรับโปรโมชั่นนี้'), 4000);
        setTimeout( () => applyTimeoutTemplate(2, 'มีของขวัญและในสต็อก!'), 6000);
    ...
    function toOffer() {
        window.location.replace(`https://wlid0.bemobtrcks.com/click`);
    }
